...
namespace SistemaBancario.CaixaEletronico.Controls
{
    public partial class ucSaque : UserControl, IPagina
    {
        ...
        public event EventHandler<ValorSaqueEventArgs> Sacar;

        private void button1_Click(object sender, EventArgs e)
        {
            Sacar?.Invoke(sender, new ValorSaqueEventArgs(10));
        }

        private void button2_Click(object sender, EventArgs e)
        {
            Sacar?.Invoke(sender, new ValorSaqueEventArgs(20));
        }

        private void button3_Click(object sender, EventArgs e)
        {
            Sacar?.Invoke(sender, new ValorSaqueEventArgs(50));
        }

        private void button4_Click(object sender, EventArgs e)
        {
            Sacar?.Invoke(sender, new ValorSaqueEventArgs(100));
        }

        private void button5_Click(object sender, EventArgs e)
        {
            Sacar?.Invoke(sender, new ValorSaqueEventArgs(200));
        }
